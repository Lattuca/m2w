...
ActiveRecord::Schema.define(version: 20150901034651) do
  ...
  add_index "rail_cars", ["purchaseorder_id"], name: "index_rail_cars_on_purchaseorder_id"
  add_index "rail_cars", ["vendor_id"], name: "index_rail_cars_on_vendor_id"
  ...
  add_index "trailers", ["purchaseorder_id"], name: "index_trailers_on_purchaseorder_id"
